...
\begin{document}
    ...
    \newpage
    \section{File System Management Guidelines}
    \subsection{Preamble}
    ...
    \newpage
    \subsection{Rules List}

    \nexusrule{Only the English letter  characters [A-Z] and numbers [0-9] are allowed to be used in file names.} \newline

    \nexusrule{All file names MUST be in snake\textunderscore case: ( All letters MUST be in lowercase, instead of space underscore(\textunderscore ) is used ).} \newline
