...
\begin{document}
    ...
    \nexusrule{All codes MUST have \important{at least} 80 percent of unit test coverage acceptance before being merged to the master ( Main.Project ). } \newline

    \nexusrule{All unit test codes must have at \important{at least} 80 percent of mutation test coverage acceptance.}
