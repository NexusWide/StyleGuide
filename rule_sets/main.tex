...
\begin{document}
    ...
    \nexusrule{Headers should not be \textbf{bolded}, \textit{italic}, ETC, they MUST be displayed in simple text.} \newline

    \nexusrule{All headers MUST be the highest priority header ( \# ), Usage of other headers is not allowed.} \newline

    \nexusrule{All english language sentence rules MUST be applied to headers ( Example: Sentence MUST start with the uppercased first character ).} \newline
