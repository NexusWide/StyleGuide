...
\begin{document}
    ...
    \subsection{\header{Examples}}
        ...
        \begin{figure}[h!]
            \fbox{\includegraphics[width=13.5cm, height=4.5cm]{/home/nimabavar/Desktop/work/diary/projects/nexus_wide/repositories/style_guide/attachments/organizing_file_style/example1.png}}
        \end{figure}
