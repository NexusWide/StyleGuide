...
\begin{document}
    ...
    Although we have mentioned all the human preference related topics in the previous sections,
    and have cited that in order to avoid disruption in the development process of a certain application,
    we MUST avoid interpolating our own preferences for labeling objects in the environment, \newline

    It is not only the label of the objects which is the matter of discuss,
    but also their content,
    as it doesn't matter how clear and meaningful the label of a binary code file is,
    it is still unreadable for a normal human being. \newline

    This matter also includes human-written text and raw ASCII files,
    as most of the time while reading and interpreting contents written by another person,
    due to the persons preference in the way of representing intelligence,
    ...
    and that is, the inclusion of a consistent and durable set of guidelines which can be read at the following pages.
