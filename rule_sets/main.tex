...
\begin{document}
    ...
    In this state, the absence of a similar style would result in numerous time consuming conversations and courses,
    ...
    The above-mentioned illustrations become even more prominent when multiple individuals are involved in a project \newline

    By endorsing this accuracy, we have conducted  our own style guides, which can be read at the following pages
    in order to avoid the referred considerations.
