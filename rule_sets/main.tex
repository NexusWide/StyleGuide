...
\begin{document}
    ...
    \nexusrule{All codes MUST be reformatted by the PSF/Black\footnotemark{} formatter before being merged to the master ( Main.Project  ) branch.} \newline
    ...
    \footnotetext{A linter and code formatter written for Python.}
