...
\begin{document}
    ...
    \nexusrule{All programmers who use python, MUST follow the PEP8 style guide.} \newline

    \nexusrule{Programmers who use other languages, MUST follow their language style guide, but MUST still adhere to the blank line rules of PEP8.} \newline

    \nexusrule{All codes MUST be reformatted by the psf/black formatter before being merged to the main branch.} \newline

    \nexusrule{All codes MUST have \important{at least} 80 percent of unit test coverage acceptance before being merged to the master ( Main.Project branch  ) } \newline

    \nexusrule{All unit test codes must have at \important{at least} 80 percent of mutation test coverage accpetance}
