...
\begin{document}
    ...
    \newpage
    \section{\header{Markdown Markup Language Style}}a
    \subsection{\header{Preamble}}

    % paragraph_points:
        % Why is having markdown language guidelines important?
        % What are the impacts of suitable markdown language guidelines on team communications?
        % What are the outcomes of not proposing acceptable foundations for our communications through the markdown language?
        % Here are our markdown language guidelines, study them precisely.


    Direct communication is a trait of the beings nature
    ...
    until this moment,
    in which you are reading this documentation through a Liquid Crystal or Cathode Ray Tube monitor. \newline
    ...
    and that is, common understanding. \newline

    This common understanding was obtained by numerous methodologies,
    including shapes, languages, literature, typefaces, fonts and currently, markups. \newline
    ...
    a apprehended set of Markup tags are capable of achieving the same results. \newline

    There is only one unsatisfactory acceptance that we have to make in order to acquire
    common understanding, and it is that both of the speakers and messengers, shall speak the same language. \newline

    And this rule also applies to our Brave New Sillicon Valley alike communications,
    indicating that if we do not speak the same language as each other,
    we would have to invest superior hours, explaining the foundation of our language to others. \newline

    The solution to this problem, is yet known,
    and it is that for all humans around the globe, to speak the same language. \newline

    In order to decrease the happening of such communication degrades in our own organization,
    we have also produced rules and guidelines for our spoken language, The Markdown Documentation Format.
    which can be read the following pages. \newline
