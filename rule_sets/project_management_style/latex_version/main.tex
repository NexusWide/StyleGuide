...
\begin{document}
    ...
    \nexusrule{    10. During the pre release phase all changes in the development process are a part of the version numbering.} \newline

    \nexusrule{     11. The release version numbering MUST govern only the user side features. } \newline

    \nexusrule{    12. When a project reaches the release phase, a ( changelog.md ) file MUST be implemented in the repository ( docs ) directory.
    } \newline
