...
\begin{document}
    ...
    \section{\header{Rules}}
      ...
      \newpage
      \nexusrule{ Issue names MUST follow the corresponding regular expression: \newline ( { Issue Title } | { Issue numeral ccount } ), \newline ( e.x: problem(docs): remove harsh rules | 3 ) .} \newline\nopagebreak
