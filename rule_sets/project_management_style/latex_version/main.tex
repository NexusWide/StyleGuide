...
\newcommand{\example}[1]{{$\rangle\hspace{0.3cm} \underline{e.x: }$ \bfseries: ( #1 )}}
%
...
\begin{document}
    ...
    \begin{tabular}{r l}
        ...
        \example{Bold text with angle sign} & Rule example \tabularnewline
    ...
    \section{\header{Project Management Rules}}
