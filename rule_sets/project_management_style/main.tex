...
\begin{document}
    ...
    \subsection{Examples}
        ...
        \begin{figure}[h!]
            \fbox{\includegraphics[width=14cm, height=6.5cm]{/home/nimabavar/Desktop/work/diary/projects/nexus_wide/repositories/style_guide/rule_sets/project_management_style/example1.png}}
            \caption{Example of \name{NexusWide} name conventions.}
        \end{figure}

        \begin{figure}[h!]
            \fbox{\includegraphics[width=14cm, height=6cm]{/home/nimabavar/Desktop/work/diary/projects/nexus_wide/repositories/style_guide/rule_sets/project_management_style/example2.png}}
